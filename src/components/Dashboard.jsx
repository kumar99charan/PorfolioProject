  ...
  return (
    ...
    <Box className="HomeContainer">
      ...
      <AppBar className="AppBar" position="fixed" open={drawerOpen} >
        <Toolbar>
          ...
          <Box className="Profile" sx={{mr: 2}}>
              <Avatar alt="Charan" src={userProfileDefaultData.Photo} sx={{cursor: 'pointer', border: '3px solid white'}} onClick={handleClick}/>
              <Menu
                id="basic-menu"
                anchorEl={anchorEl}
                open={openAvatarMenu}
      ...
      <Drawer variant="permanent" open={drawerOpen}  >
        <DrawerHeader  sx={{bgcolor:'#f1faee'}}className={`${drawerOpen ? "show sideFloatClass": "hide"}`} >
          <Avatar alt={userName} src={defaultImage} sx={{cursor: 'pointer', margin: 'auto'}} />
        ...
        <Divider />
        <List className="sideMenuContainer" sx={{background: 'transparent',bgcolor:'#f1faee'}}>
        {
